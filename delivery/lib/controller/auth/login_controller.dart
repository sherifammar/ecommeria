...
class LogincontrollerImp extends Logincontroller {
        ...
        if (response['status'] == "success") {
          if (response["data"]["delivery_approve"] == "1") {
            myservices.sharedPreferences.setString(
                "id",
                response["data"][
                    "delivery_id"]); // "data" name of var from getdata in function.php page users_id == name of colum in database
            ...
            FirebaseMessaging.instance
                .subscribeToTopic("delivery"); //send notification all users
            FirebaseMessaging.instance.subscribeToTopic(
                'delivery${userid}'); //send notification certain user only
            // ==========================
 ...
 determinePosition(); // make permission of google map
