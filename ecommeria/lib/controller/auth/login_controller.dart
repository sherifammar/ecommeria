...
import '../../core/function/alertaddaddress.dart';
        ...
        if (response['status'] == "success") {
          if (response["data"]["users_approve"] == "1") {
            myservices.sharedPreferences.setString(
                "id",
                response["data"][
                    "users_id"]); // "data" name of var from getdata in function.php page users_id == name of colum in database
            ...
            FirebaseMessaging.instance.subscribeToTopic(
                'users${userid}'); //send notification certain user only
            // ==========================
